...
public class ValueTransMethod {
	...
	public String doTrans2(String fieldid,String value,String type){
		String tablename = "";
		String fieldtype = "";
		String texttype = "";
		String buttontype = "";
		...
		try {
			return getTransValue2(fieldtype,texttype,buttontype,selectbutton,value);
		} catch (Exception e) {
			return value;
		}
	}
	
	public String getTransValue2(String fieldtype,String texttype,String buttontype,String selectbutton,String value) throws Exception{
		//BaseBean log = new BaseBean();
		String result ="";
		if("0".equals(fieldtype)){
			result = value;
