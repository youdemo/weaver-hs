...
public class SysnOutDataAction extends BaseCronJob{
	...
	public void sysnData(){
		...
		doSysn(month,day,hour,min,nowDate,nowTime);
	}
	
	public void doSysn(String month,String day,String hour,String min,String nowDate,String nowTime){
