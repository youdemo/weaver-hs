...
public class SysnCptBusOutDataImpl {
	 ...
	 * @return
	 */
	public List<CptBusOutDataMtBean> getSysnMtIds(String month,String day,String hour){
		String sql = "";
		String id = "";
		String datasource = "";
		String type = "";
		...
		sql = "select *  from uf_prj_syscptbus_mt where (month='"+month+"' or month='0') and (day='"+day+"' or day='0') and (hour='"+hour+"' or hour='0') and isused='1' ";
