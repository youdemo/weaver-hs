...
<%
  ...
  url_1 = "/hsproject/project/view/hs-add-process.jsp?prjid="+prjid+"&prjtype="+prjtype+"&processtype="+processtype;
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">新建项目阶段</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       <li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">新建项目阶段<span id="allNum_span"></span></a>
				</li>
