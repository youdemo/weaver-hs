...
<%
 String processname="";
  ...
  String sql="select processname,prjtype,processtype from hs_prj_process where id="+processid;
  rs.executeSql(sql);
  if(rs.next()){
  ...
  url_1 = "/hsproject/project/view/hs-edit-process.jsp?id="+processid+"&prjtype="+prjtype+"&processtype="+processtype;
%>
