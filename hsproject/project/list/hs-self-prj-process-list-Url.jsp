...
<%
	...
	String url_5= "";
	String url_6="";
	url_1 = "/hsproject/project/list/hs-self-prj-process-list.jsp";
%>
		...
		<div class="e8_boxhead">
			...
			<div class="e8_ultab">
				<div class="e8_navtab" id="e8_navtab">
					<span id="objName">项目阶段列表</span>
				</div>
				<div>
		    <ul class="tab_menu">
		       <li class="current">
					<a target="tabcontentframe" href="<%=url_1%>">项目阶段列表<span id="allNum_span"></span></a>
				</li>
