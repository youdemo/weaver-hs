...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<wea:group context='<%=SystemEnv.getHtmlLabelName(18375,user.getLanguage())%>' attributes="{'groupDisplay':'none'}">
		...
		%>
			...
			<div class="listbox2" >
						<div class='titleitem'>
							<div class="titlecontent" style="border-bottom:2px solid <%=color[0] %>;"><label>项目类型</label></div>								
						</div>
						<div class="mainItem">
						<%
							ProjectTypeDao ptd = new ProjectTypeDao();
							List<ProjectTypeBean> ptblist = ptd.getUsedProjectType();
							if(userid != 1){
								ptblist = ptd.getUsedProjectType(userdp);
							}
