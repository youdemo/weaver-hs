...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
	...
	<BODY>
		...
		String fromSql  =  " from uf_prj_report_conf ";
		...
		operateString+
		"			<head>";
				tableString +="<col width=\"20%\" text=\"报表名称\" column=\"reportname\" orderkey=\"reportname\" linkvaluecolumn=\"id\" linkkey=\"reportid\" href= \"/hsproject/project/report/hs-prj-report-config-edit-url.jsp\" target=\"_fullwindow\"/>"+ 
	...
	<script type="text/javascript">
		...
		function createReport(){
			window.open("/hsproject/project/report/hs-prj-report-config-url.jsp?prjtype=<%=prjtype%>","_bank");
		}
