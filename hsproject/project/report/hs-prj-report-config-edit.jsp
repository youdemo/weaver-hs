...
<%@ page import="hsproject.bean.PrjReportBean" %>
<%@ page import="hsproject.dao.PrjReportDao" %>
...
<link rel="stylesheet" type="text/css" href="/js/jquery-autocomplete/browser_wev8.css" />
    ...
    String out_pageId = "xmxxbbpzedit";
    ...
    String reportname_mt=prt.getReportName(reportid_mt);
    Map<String, String> reportShowMap = prt.getReportShowMap(reportid_mt);
    //out.print(reportShowMap.size());
    Map<String, String> reportQueryMap = prt.getReportQueryMap(reportid_mt);
    Map<String, String> dsporderMap = prt.getReportDsporderMap(reportid_mt);
    //out.print(reportQueryMap.size());
	%>
	<BODY>
		<div id="tabDiv">
						    ...
						    <wea:layout type="table" attributes="{'cols':'5','cws':'20%,20%,20%,20%,20%'}">
								<wea:group context="报表设置" attributes="{\"groupDisplay\":\"none\"}">
									...
									for(ProjectFieldBean pfb:pfblist){
										...
										if(!"".equals(Util.null2String(reportShowMap.get(fieldname)))){
											showcheckvalue = "1";
										}
										if(!"".equals(Util.null2String(reportQueryMap.get(fieldname)))){
											querycheckvalue = "1";
										}

										String dsporder = "0.00";
										if(!"".equals(Util.null2String(dsporderMap.get(fieldname)))){
											dsporder = dsporderMap.get(fieldname);
										}
