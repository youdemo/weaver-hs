...
<%
	...
	String prjtype = "";
	String sql="select prjtype from uf_prj_all_reportmt where id="+reportid;
	rs.executeSql(sql);
	if(rs.next()){
		prjtype = Util.null2String(rs.getString("prjtype"));
	}

	url_1 = "/hsproject/project/report/hs-prj-all-report-config-edit.jsp?prjtype_mt="+prjtype+"&reportid_mt="+reportid;
%>
