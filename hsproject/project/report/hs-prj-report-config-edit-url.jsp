...
<%
	...
	String prjtype = "";
	String sql="select prjtype from uf_prj_report_conf where id="+reportid;
	rs.executeSql(sql);
	if(rs.next()){
		prjtype = Util.null2String(rs.getString("prjtype"));
	}

	url_1 = "/hsproject/project/report/hs-prj-report-config-edit.jsp?prjtype_mt="+prjtype+"&reportid_mt="+reportid;
%>
